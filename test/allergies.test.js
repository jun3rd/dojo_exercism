...
describe.skip('Allergies', () => {
  describe.skip('testing for eggs allergy', () => {
  ...
  describe.skip('testing for peanuts allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
  ...
  describe.skip('testing for shellfish allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
  ...
  describe.skip('testing for strawberries allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
  ...
  describe.skip('testing for tomatoes allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
  ...
  describe.skip('testing for chocolate allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
  ...
  describe.skip('testing for pollen allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
  ...
  describe.skip('testing for cats allergy', () => {
    xtest('not allergic to anything', () => {
      const allergies = new Allergies(0);
