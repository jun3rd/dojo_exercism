...
describe.skip('diffie-hellman', () => {
  xtest('throws an error if the constructor arguments are out of range', () => {
    expect(() => {
  ...
  describe.skip('input validation', () => {
    const p = 23;
    const g = 5;
    // const diffieHellman = new DiffieHellman(p, g); // JUN >>>> re-implement this when READY
  ...
  describe.skip('stateless calculation', () => {
    // const diffieHellman = new DiffieHellman(23, 5); // JUN >>>> re-implement this when READY
