...
describe.skip('grep exercise', () => {
  describe.skip('Test grepping a single file', () => {
    // NOTE: match BELOW
    xit('One file, one match, no flags', () => {
      return expect(
        spawnGrep({
          pattern: 'Agamemnon',
          flags: [],
  ...
  describe.skip('Test grepping multiples files at once', () => {
